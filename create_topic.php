...
<div id="about" class="text-center">
      ...
      <h1><strong><span class="color">Create New Thread</span></strong></h1>
      <div class="line">
                        <hr>
                    </div>
                </div>
<div id="content">
<form id='createthread' action="create_topic_parse.php" method="post">
<h4>Thread Title</h4>
<input type="text" id = 'title' name="topic_title" size="98" maxlength="150"/>
<h4>Content</h4> 
<textarea name="topic_content" id = 'content' rows="5" cols="75"></textarea>
<br /><br />
<input type="hidden" name="cid" value="<?php echo $cid; ?>"/>
<input type="submit" name="topic_submit" value="Create Thread"/>
</form>
</div>
</div>
</body>
